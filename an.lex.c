...
struct Token {
    ...
    char name[40];      // se usar para imprimir los tokens 
    char lexema[40];    // se usar para imprimir la tabla de simbolos
    char tipo[40];      // se usar para imprimir la tabla de simbolos
    char valor[40];     // se usar para imprimir la tabla de simbolos
...
// declaracion de los arreglos que se encargan de almacenar los tokens (ver archivo TOKENS.doc del Tp)
    char constanteEntera [40] = {0}; char constanteReal [40] = {0};
    char constanteString [40] = {0}; char IdPalabraReservada [40] = {0};
    char operador [40] = {0}; char comparador [40] = {0}; char otro[40] = {0};

// variables globales a todo el programa
    int estado_actual = 0; int estado_segundo = 0;  // para ver que token formara
    int estado_final = 28; int estado_error = 29;
    int hay_error = 0; int position_row = 1;  // arranca leyendo siempre la primera fila
    char caracter = ' '; struct Token token_confirmado;

// archivos
    FILE * input = NULL;  FILE * lista_tokens = NULL; FILE * tabla_simbolos = NULL; FILE * tokens_unicos = NULL;
////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////
int main(){ // INICIO MAIN
    input = fopen("input.txt", "rb"); lista_tokens = fopen("lista_tokens.txt", "w");
    tabla_simbolos = fopen("tabla_simbolos.txt", "w"); tokens_unicos = fopen("tokens_unicos.txt", "w+");
